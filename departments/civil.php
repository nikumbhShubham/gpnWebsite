...
$dept = $conn->query("SELECT * FROM staff_admin WHERE dept = 'CE'");
...
<head>
    ...
    <title>GPN | Civil Engineering </title>
...
<body>
    ...
    <!-- ======= Hero Section ======= -->
    <section class="hero-section civil_hero">
        <div class="mt-5">
            <div class="text-center" data-aos="zoom-in">
                <h1>We Shape our Buildings,</h1>
                <h2>There after they Shape us.</h2>
            </div>
        </div>
    </section>
    <!-- End Hero -->
                    ...
                    <div class="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center" data-aos="fade-up">
                        <div>
                            <h3>Survey Lab<br>
                                ...
                                Model Lab<br>
                                CAD Lab<br>
                                Environment Engg. Lab<br>
                                Applied Mechanics-Lab 1<br>
                                Applied Mechanics-Lab 2<br>
                                Material Testing<br>
                                Concrete Technology and Geotech Lab</h3>
                        ...
                        <div id="carouselExampleControls" class="carousel slide carousel-fade " data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="navbar-assets/img/civil/lab1.jpg" class="d-block w-100 rounded shadow-lg" alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="navbar-assets/img/civil/lab2.jpg" class="d-block w-100 rounded shadow-lg" alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="navbar-assets/img/civil/lab3.jpg" class="d-block w-100 rounded shadow-lg" alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="navbar-assets/img/civil/lab4.jpg" class="d-block w-100 rounded shadow-lg" alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="navbar-assets/img/civil/lab5.jpg" class="d-block w-100 rounded shadow-lg" alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="navbar-assets/img/civil/lab6.jpg" class="d-block w-100 rounded shadow-lg" alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="navbar-assets/img/civil/lab7.jpg" class="d-block w-100 rounded shadow-lg" alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="navbar-assets/img/civil/lab8.jpg" class="d-block w-100 rounded shadow-lg" alt="...">
                                </div>
                            </div>
                        </div>
                        ...
                        <ul class="faq-list">
                            ...
                            <li>
                                ...
                                <div id="faq1" class="collapse" data-bs-parent=".faq-list">
                                    <p>
                                        To develop practice school for design, construction and management of Civil Engineering work having focused on the manpower development based on project based learning and technology based practices. The department shall have the centre of testing, consultancy and construction management and thereby providing the practice environment to aspiring learners.
                                    </p>
                                </div>
                            </li>
                            ...
                            <li>
                                ...
                                <div id="faq2" class="collapse" data-bs-parent=".faq-list">
                                    <p>
                                        M1. To develop competent Diploma Civil Engineers with ethical values for social-economical development.<br>
                                        ...
                                        M4. To offer continuing education programmes and consultancy services for betterment of society.<br>
                                    </p>
                                </div>
                            </li>
                            ...
                            <li>
                                ...
                                <div id="faq3" class="collapse" data-bs-parent=".faq-list">
                                    <p class="description text-start">To develop a Civil Engineer capable of working in diversified fields of construction industry.<br>
                                        To inculcate professional and entrepreneurial abilities in the students.<br>
                                        To develop students with ethical, team building and lifelong learning skills.</p>
                                </div>
                            </li>
                            ...
                            <li>
                                ...
                                <div id="faq4" class="collapse" data-bs-parent=".faq-list">
                                    <p class="description text-start">Carry out survey, prepare plan and estimate for Civil Engineering works <br>
                                        Co-ordinate and supervise construction activities. <br>
                                        Assist in design and drafting of Civil Engineering structures</p>
                                </div>
                            </li>
                                ...
                                <div id="faq11" class="collapse" data-bs-parent=".faq-list">
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-bordered table-responsive description table-fluid w-full">
                                            ...
                                            <tr>
                                                <td>01</td>
                                                <td>Shri. S. R. Deshmukh <br>Head of Civil Engineering Department</td>
                                                <td>Chairman</td>
                                            </tr>
                                            <tr>
                                                <td>02</td>
                                                <td>Dr. K. B. Ladhane<br>Head of Civil Engineering Department</td>
                                                <td>Member</td>
                                            </tr>
                                            <tr>
                                                <td>03</td>
                                                <td>Shri. S. G. Pagare<br>Industry Expert</td>
                                                <td>Member</td>
                                            </tr>
                                            <tr>
                                                <td>04</td>
                                                <td>Shri. S. G. Pandit<br>Industry Expert</td>
                                                <td>Member</td>
                                            </tr>
                                            <tr>
                                                <td>05</td>
                                                <td>Shri. Abhay Choksi<br>Industry Expert</td>
                                                <td>Member</td>
                                            </tr>
                                            <tr>
                                                <td>06</td>
                                                <td>Shri R. S. Narkhede<br>Programme Expert from Neighbouring Institute</td>
                                                <td>Member</td>
                                            </tr>
                                            <tr>
                                                <td>07</td>
                                                <td>Shri R. G. Sonone<br>Senior Lecturer from Programme
                                                </td>
                                                <td>Member</td>
                                            </tr>
                                            <tr>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-2 d-flex flex-column justify-content-center" data-aos="fade-up">
                        <div>
                            Modernization of survey lab, environmental lab.
                            Development of transportation engineering lab.
                            Implant training for final year students in vacation period.
