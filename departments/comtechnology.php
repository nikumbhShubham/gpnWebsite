...
$dept = $conn->query("SELECT * FROM staff_admin WHERE dept = 'CM'");
...
<head>
    ...
    <title>GPN | Computer Technology</title>
...
<body>
    ...
    <header id="header" class="fixed-top d-flex align-items-center">
        <div class="container d-flex align-items-center">
            ...
            <div class="logo me-auto">
                <h1 class="fs-6"><a href="../index.php">CM</a></h1>
    ...
    <!-- ======= Hero Section ======= -->
    <section class="hero-section comtechnology_hero">
        <div class="mt-5">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center" data-aos="fade-up">
                        <div>
                            <h3>CM-Programming Lab-1<br>
                                CM-Software Testing/Multimedia Lab-2<br>
                                CM-Hardware Lab<br>
                                CM-Microprocessor Lab-1<br>
                                CM-Network/Internet Lab<br>
                            </h3>
                        ...
                        <div id="carouselExampleControls" class="carousel slide carousel-fade " data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="navbar-assets/img/comtechnology/lab1.jpg" class="d-block w-100 rounded shadow-lg" alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="navbar-assets/img/comtechnology/lab2.jpg" class="d-block w-100 rounded shadow-lg" alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="navbar-assets/img/comtechnology/lab3.jpg" class="d-block w-100 rounded shadow-lg" alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="navbar-assets/img/comtechnology/lab4.jpg" class="d-block w-100 rounded shadow-lg" alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="navbar-assets/img/comtechnology/lab5.jpg" class="d-block w-100 rounded shadow-lg" alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="navbar-assets/img/comtechnology/lab6.jpg" class="d-block w-100 rounded shadow-lg" alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="navbar-assets/img/comtechnology/lab7.jpg" class="d-block w-100 rounded shadow-lg" alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="navbar-assets/img/comtechnology/lab8.jpg" class="d-block w-100 rounded shadow-lg" alt="...">
                                </div>
                            </div>
                        </div>
        ...
        <section class="container services">
            <div class="table-responsive">
                ...
                <table class="container table table-bordered ">
                    ...
                    <tr>
                        <td>01</td>
                        <td> CM-Programming Lab-1</td>
                        <td>84</td>
                    </tr>
                    <tr>
                        <td>02</td>
                        <td>CM-Software Testing/Multimedia Lab-2</td>
                        <td>84</td>
                    </tr>
                    <tr>
                        <td>03</td>
                        <td> CM-Hardware Lab</td>
                        <td>100</td>
                    </tr>
                    <tr>
                        <td>04</td>
                        <td>CM-Microprocessor Lab-1</td>
                        <td>100</td>
                    </tr>
                    <tr>
                        <td>05</td>
                        <td>CM-Network/Internet Lab-2</td>
                        <td>100</td>
                    </tr>
                </table>
            </div>
                        ...
                        <ul class="faq-list">
                            ...
                            <li>
                                ...
                                <div id="faq1" class="collapse" data-bs-parent=".faq-list">
                                    <p>
                                        To achieve quality education to deal with rapidly changing technologies which produce competent manpower to address the global challenges and contribute to the field of computer technology.
                                    </p>
                                </div>
                            </li>
                            ...
                            <li>
                                ...
                                <div id="faq2" class="collapse" data-bs-parent=".faq-list">
                                    <p>
                                        Department of Computer Technology is committed<br>
                                        M1. To make the student to Anticipate and respond effectively.<br>
                                        M2. To develop innovative skills and act robust and reliable ways to solve the engineering problems ethically with integrity.<br>
                                        M3.To secure technological and decision-support services and applications to inspire student.<br>
                                        M4. To empower employers, stake holders and ultimately advance the state of education in the nation.<br>
                                        M5. To encourage student for employable, entrepreneurial and life- long learning skill and develop leadership skills with social sensitivity.
                                    </p>
                                </div>
                            </li>
                            ...
                            <li>
                                ...
                                <div id="faq3" class="collapse" data-bs-parent=".faq-list">
                                    <p class="description text-start">TTo produce innovative technical leaders those are able to contribute towards achievement of computer technology.<br>

                                        Students will be able to lead a team of diversified professionals with good communication skills, leadership virtues and professional ethics.<br>

                                        Students will have the capability to identify social issues or crisis or problems or calamities and will be able to find solutions by applying concepts of computer technology.<br>

                                        Students will able to apply mathematics and scientific concepts for formulating analyzing and solving real world problems of engineering.</p>
                                </div>
                            </li>
                            ...
                            <li>
                                ...
                                <div id="faq4" class="collapse" data-bs-parent=".faq-list">
                                    <p class="description text-start">Apply the basic concepts in various domains of Computer Technology Programme such as Software Development (Programming), Operating System, PC Architecture and maintenance, Software Testing, Database Management System, Computer Network and Security, Embedded System, System Software and Computer Graphics.<br>

                                        Demonstrate the knowledge and skills by applying the principles of hardware and software of Computer systems.<br>

                                        Work effectively on various technical projects to satisfy the stakeholder needs.<br>

                                        Utilize the engineering practices with professional ethics for societal and environmental welfare.</p>
                                </div>
                            </li>
                            ...
                            <li>
                                ...
                                <div id="faq6" class="collapse" data-bs-parent=".faq-list">
                                    ...
                                    <p class="description text-start">
                                        ...
                                        Department is Conducting online examination<br>
                                        ...
                                        Department is handling institute level admission process
                                    </p>
                                </div>
                            </li>
                            <li>
                                ...
                                <div id="faq7" class="collapse" data-bs-parent=".faq-list">
                                    <div class="table-responsive">
                                        ...
                                        <table class="container table table-bordered table-responsive description table-fluid w-full">
                                            ...
                                            <tr>
                                                <td>Shri U.V.Kokate</td>
                                                <td>2</td>
                                                <td>10</td>
                                            </tr>
                                            <tr>
                                                <td>Miss N.S.Nikale</td>
                                                <td>0</td>
                                                <td>10</td>
                                            </tr>
                                            <tr>
                                                <td>Shri. T.D.Pawar</td>
                                                <td>0</td>
                                                <td>10</td>
                                            </tr>
                                            <tr>
                                                <td>Shri. M. S. Khedkar</td>
                                                <td>2</td>
                                                <td>3</td>
                                            </tr>
                                ...
                                <div id="faq11" class="collapse" data-bs-parent=".faq-list">
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-bordered table-responsive description table-fluid w-full">
                                            ...
                                            <tr>
                                                <td>01</td>
                                                <td> N.S.Nikale <br>I/C, HOD, Computer Technology Department</td>
                                                <td>Chairman</td>
                                            </tr>
                                            <tr>
                                                <td>02</td>
                                                <td>Shri.K. M. Vyas<br>Industry representative</td>
                                                <td>Member</td>
                                            </tr>
                                            <tr>
                                                <td>03</td>
                                                <td>Shri. Anurag A.Kenge<br>Industry representative</td>
                                                <td>Member</td>
                                            </tr>
                                            <tr>
                                                <td>04</td>
                                                <td>Shri. S. M. Gorade<br>Industry representative</td>
                                                <td>Member</td>
                                            </tr>
                                            <tr>
                                                <td>05</td>
                                                <td>Smt. Gayatri R. Jagtap<br>Programme Expert from Neighbouring Institute</td>
                                                <td>Member</td>
                                            </tr>
                                            <tr>
                                                <td>06</td>
                                                <td>Smt. Tejashree D. Pawar<br>Lecturer From Programme</td>
                                                <td>Member</td>
                                            </tr>
                                            <tr>
                                                <td>07</td>
                                                <td>Smt. Manisha P. Wakchaure<br>Lecturer From Programme
                                                </td>
                                                <td>Member</td>
                                            </tr>
                                            <tr>
                                                <td>08</td>
                                                <td>Shri. Akshay D. Joshi<br>MSBTE Representative
                                                </td>
                                                <td>Member</td>
                                            </tr>
                                            <tr>
