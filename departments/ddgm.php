...
$dept = $conn->query("SELECT * FROM staff_admin WHERE dept = 'DDGM'");
...
<body>
    ...
    <!-- ======= Hero Section ======= -->
    <section class="hero-section ddgm_hero">
        <div class="mt-5">
            <div class="text-center" data-aos="zoom-in">
                <h1>The fashion is the armor to survive, </h1>
                <h2> the reality of everyday life.</h2>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center" data-aos="fade-up">
                        <div>
                            <p class="h4">Laboratory of Dress Designing & Garddgmnt Manufacturing Department <br><br> </p>
                            <ol>
                                <li>Dyeing And Printing Lab</li>
                                <li>Apparel Constuction Lab</li>
                                <li>Drafting and Cutting Lab</li>
                                <li>Fashion Illustration Lab</li>
                                <li>Computer Lab</li>
        ...
        <section class="container services">
            <div class="table-responsive">
                ...
                <table class="container table table-bordered ">
                    ...
                    <tr>
                        <td>01</td>
                        <td>Dyeing And Printing Lab</td>
                        <td>33.00</td>
                    </tr>
                    <tr>
                        <td>02</td>
                        <td>Apparel Constuction Lab</td>
                        <td>102.00</td>
                    </tr>
                    <tr>
                        <td>03</td>
                        <td>Drafting and Cutting Lab</td>
                        <td>102.00</td>
                    </tr>
                    <tr>
                        <td>04</td>
                        <td>Fashion Illustration Lab</td>
                        <td>204.00</td>
                    </tr>
                    <tr>
                        <td>05</td>
                        ...
                        <ul class="faq-list">
                            ...
                            <li>
                                ...
                                <div id="faq1" class="collapse" data-bs-parent=".faq-list">
                                    <p>
                                        Dress Designing and Garment Manufacturing will be a national trendsetter for nurturing entrepreneurs, responsible professionals in garment designing and apparel engineering providing technologically sound learning environment to satisfy the apparel stakeholders.
                                    </p>
                                </div>
                            </li>
                            ...
                            <li>
                                ...
                                <div id="faq2" class="collapse" data-bs-parent=".faq-list">
                                    <p>M1. The Dress Designing and Garment Manufacturing Department provides diploma programme to develop aesthetic and technical manpower in designing, manufacturing and value addition area of apparel sector. <br><br>
                                        M2. To inculcate elaborate values of ethical designing, creativity, professionalism with more customer oriented approach. <br><br>
                                        M3. Provide practical learning environment to enhance creativity for employability and entrepreneurship.
                                    </p>
                                </div>
                            </li>
                            ...
                            <li>
                                ...
                                <div id="faq3" class="collapse" data-bs-parent=".faq-list">
                                    <p>
                                        Can work at supervisory levels and Merchandiser & pattern maker position in an apparel industry. <br><br>

                                        Entrepreneur of small scale industry with respect to boutiques, secondary process sampler, job workers, etc. <br><br>

                                        Can work as computer aided designer and also work for advertising agencies as copy, art and layout artist & as Instructor in fashion institutes.
                            ...
                            <li>
                                ...
                                <div id="faq4" class="collapse" data-bs-parent=".faq-list">
                                    <p>
                                        ...
                                        <b>Basic and Discipline specific knowledge</b>:Designer need to apply knowledge of illustration, designing, and manufacturing process and the problem related with that. <br><br>

                                        <b>Problem analysis</b>: Designer need to do effective forecast and analyze problem related with the industry. <br><br>

                                        <b>Design/ development of solutions </b>:Design process for well defined technical problem and find solution to fulfilled specified needs for society. <br><br>

                                        <b>Engineering Tools, Experimentation and Testing</b>: For designer it is very important to use modern technique and tools for best result as we need to compete globally. <br><br>

                                        <b>Engineering practices for society, sustainability and environment</b>: It is our most important responsibility to save mother earth by behaving and taking care of all social aspects and thought of sustainability need to take care of environment and need to apply ethical practices during your career. <br><br>

                                        <b>Project Management</b>: Should be based on case study and with actually implemented project in a team and with defined activities. <br><br>

                                        <b>Life-long learning</b>: Developed ability to analyze individual needs and engage in updating in the context of regular technological up gradation.
                            ...
                            <li>
                                ...
                                <div id="faq5" class="collapse" data-bs-parent=".faq-list">
                                    <p>
                                        Understand the professional and ethical responsibilities in the local and global context and hence utilize their knowledge and skills for the benefit of the society. <br><br>

                                        Develop and initialize a design vocabulary, an essential tool for practicing as designers.
                                        <br><br>
                                        The world of fashion designing, textile and apparel industry through production processes with the various roles and responsibilities.
                                    </p>
                                </div>
                            </li>
                            ...
                            <li>
                                ...
                                <div id="faq6" class="collapse" data-bs-parent=".faq-list">
                                    <p>
                                        Work out Earn & learn plans for students. <br><br>
                                        AICTE through Community College is run. <br><br>
                                        Department organizes at least one social activity a year. <br><br>
                                        Department organizes display cum exhibition and fashion show to showcase and provide the students term work.

                                    </p>
                                </div>
                            </li>
                            <li>
                                <div data-bs-toggle="collapse" href="#faq7" class="collapsed question">Staff Achievemnts <i class="bi bi-chevron-down icon-show"></i><i class="bi bi-chevron-up icon-close"></i></div>
                                ...
                                <div id="faq11" class="collapse" data-bs-parent=".faq-list">
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-bordered table-responsive table-striped mt-4">
                                            ...
                                            <tr>
                                                <td>01</td>
                                                <td>Mrs S.V.Bane Head of DDGM Department</td>
                                                <td>Chairman</td>
                                            </tr>
                                            <tr>
                                                <td>02</td>
                                                <td>Mr Vijay Khandve Industry Expert</td>
                                                <td>Member</td>
                                            </tr>
                                            <tr>
                                                <td>03</td>
                                                <td>Mr Ashok Mote Industry Expert</td>
                                                <td>Member</td>
                                            </tr>
                                            <tr>
                                                <td>04</td>
                                                <td>Ms. Prapti Mahajan Industry Expert</td>
                                                <td>Member</td>
                                            </tr>
                                            <tr>
                                                <td>05</td>
                                                <td>Ms Jyoti Lakde Programme Expert From Neighbouring Institute</td>
                                                <td>Member</td>
                                            </tr>
                                            <tr>
                                                <td>06</td>
                                                <td>Mrs D.C.Kshatriya Lecturer from Programme</td>
                                                <td>Member</td>
                                            </tr>
                                            <tr>
                                                <td>07</td>
                                                <td>Mrs N.N. Garude Lecturer from Programme</td>
                                                <td>Member</td>
                                            </tr>
                                            <tr>
                                                <td>08</td>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-2 d-flex flex-column justify-content-center" data-aos="fade-up">
                        <div>
                            Conducting State level Competitions and training programmes. <br><br>
                            Arranging Fashion Show. <br><br>
                            Arranging campus for students. <br><br>
                            Arranging internship in industry. <br><br>
                            Arranging Industrial Vists to Expert House. <br><br>
                            Arranging Expert Lectures. <br><br>
                            Vists To Markets & collection of Information.
